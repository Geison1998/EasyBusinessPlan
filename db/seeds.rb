...
Question.create(
    descripition: 'Quais móveis/maquinários/utensílios necessários para o negócio funcionar?',
    group_id: 4
)
Question.create(
    descripition: 'Qual são as tecnologias utilizadas? Qual o diferencial competitivo dela?',
    group_id: 4
)
Question.create(
